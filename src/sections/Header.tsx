    ...
    <div className="flex-col w-full p-8">
      ...
      <div className="flex-col mt-4 bg-teal-100 border border-teal-500 rounded-xl p-4 w-full">
        <div className="flex items-center w-auto mt-2">
          ...
          <p className="text-xl ml-4 px-3 text-teal-700 font-semibold">Berlin</p>
        </div>
        <div className="flex items-center mt-2">
          <PhoneIcon className="w-6 h-6" />
          <p className="text-xl ml-4 px-3 text-teal-700 font-semibold">+49 162 921</p>
        </div>
        <div className="flex items-center mt-2">
          <EnvelopeIcon className="w-6 h-6" />
          <p className="text-xl ml-4 px-3 text-teal-700 font-semibold">
        ...
        <div>
          ...
          >
            <img
              ...
              className="w-6 h-6"
            />
            <p className="text-xl ml-4 px-3 text-teal-700 font-semibold">LinkedIn</p>
          </a>
          <a
      ...
      <div className="flex-col mt-4 bg-teal-100 border border-teal-500 rounded-xl p-4 w-full">
        ...
        <p className="p-1 mt-2">09.2023 - 03.2024</p>
      </div>
      <div className="text-center mt-4">
        <h1 className="text-xl text-center underline underline-offset-8 font-semibold">
          SKILL'S
      ...
      <div className="grid grid-cols-2 gap-4  p-4 w-full">
        <div className="flex bg-teal-200 border border-teal-500 rounded-xl p-1 items-center gap-2 mt-2">
      ...
      <div className="grid grid-cols-2 gap-4  p-4 w-full">
        <div className="flex-col bg-teal-200 border border-teal-500 rounded-xl p-1 items-center gap-2 mt-2">
